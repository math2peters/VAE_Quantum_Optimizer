...
class VAE:
    ...
    def create_population_predictor_network(self, dropout=0.25):
        inputs = Input(shape=(self.latent_dim,))
        ...
        y_loss = Dense(128, activation=gelu, name='population_predictor_dense2')(y_loss)
        y_loss = Dropout(dropout)(y_loss)
        #y_loss = layers.BatchNormalization()(y_loss)
        y_loss = Dense(128, activation=gelu, name='population_predictor_dense3')(y_loss)
        y_loss = Dropout(dropout)(y_loss)
        y_loss = Dense(128, activation=gelu, name='population_predictor_dense4')(y_loss)
        y_loss = Dropout(dropout)(y_loss)
        #y_loss = layers.BatchNormalization()(y_loss)
