...
if __name__ == '__main__':
    ...
    low_population_train = low_population_train[-128:]
    ...
    plt.close()
    plt.ioff()
    minima = find_minima(latent_dim, population_prediction_function_with_gradient, vae, num_minima=8, penalty_scaling=4, stochasticity=6)
